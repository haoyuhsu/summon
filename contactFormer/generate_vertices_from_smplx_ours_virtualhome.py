...
if __name__ == '__main__':
    ...
    smplx_model = BodyModel(bm_fname='/projects/benk/hhsu2/imu-humans/body_models/human_model_files/smplx/SMPLX_NEUTRAL.npz', num_betas=10, model_type='smplx')
    smplx_model.eval()
    ...
    # HARDCODED path
    args.root_dir = '/work/hdd/bczy/tcheng1/exp_test_virtualhome/viz_test_generate_number'
    args.output_dir = '/projects/benk/hhsu2/imu-humans/related_works/summon/outputs/vertices_ours/virtualhome'
    args.smplx_model_dir = '/projects/benk/hhsu2/imu-humans/body_models/human_model_files/'

    args.mesh_ds_us_dir = '/projects/benk/hhsu2/imu-humans/related_works/summon/mesh_ds'
    args.gender = 'neutral'
    args.downsample = True
    args.normalize_ori = True
    ...
    for seq_fname in seq_names:

        input_file = os.path.join(args.root_dir, seq_fname)

        data = np.load(input_file, allow_pickle=True).item()
        pred_motion = data['pred']
        ...
        sequence_name = seq_fname.split('.')[0]
